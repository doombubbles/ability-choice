...
public class Biohack : HeroAbilityChoice
{
    ...
    public override Dictionary<int, string> Descriptions2 => new()
    {
        ...
        { 13, "Now biohacks the 2 closest towers for +2 damage." },
        { 19, "Biohack makes affected monkeys pop 3 extra layers instead of 2." }
    };
    ...
    public override void Apply2(TowerModel model)
    {
        ...
        biohack.affectedCount = model.tier >= 13 ? 2 : 1;
